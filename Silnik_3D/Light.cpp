...
void Light::configureLighting()
{
    ...
    case LightingMode::DIRECTIONAL_LIGHT: {
        ...
        GLfloat dirLightDir[] = { -0.3f, -1.0f, -0.7f, 0.0f }; // światło z góry pod kątem
        GLfloat dirLightDiffuse[] = { 0.5f, 0.5f, 0.5f, 1.0f };   // mniej intensywne
        GLfloat dirLightAmbient[] = { 0.15f, 0.15f, 0.15f, 1.0f }; // subtelne tło
        GLfloat dirLightSpecular[] = { 0.1f, 0.1f, 0.1f, 1.0f };  // prawie brak błysku
