...
public:
    ...
    void drawCubeNew(float scale, float offsetX, float offsetY, float vertices[24], unsigned int indices[36], float normals[24], float colors[24], BitmapHandler& bitmapHandler);
