...
int main(int argc, char** argv) {
    ...
    const std::string texture2Path = "D:/Silnik_3D/images/2.png";
    const std::string texture3Path = "D:/Silnik_3D/images/3.png";
    const std::string texture4Path = "D:/Silnik_3D/images/4.png";
    const std::string texture5Path = "D:/Silnik_3D/images/5.png";
    const std::string texture6Path = "D:/Silnik_3D/images/6.png";
    const std::string texture7Path = "D:/Silnik_3D/images/1.png";
    ...
    if (!bitmapHandler.loadTextures(texture1Path, texture2Path, texture3Path, texture4Path, texture5Path, texture6Path, texture7Path)) {
    ...
    gameEngine.setTextures(texture1Path, texture2Path, texture3Path, texture4Path, texture5Path, texture6Path, texture7Path);

    BitmapHandler cubeBitmapHandler;
    if (!cubeBitmapHandler.loadTextures(texture2Path, texture3Path, texture4Path, texture5Path, texture6Path, texture7Path, texture1Path)) {
